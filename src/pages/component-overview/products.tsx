        ...
        <Box p={1}>
                    ...
                    <Grid size={{ xs: 6, md: 3 }}></Grid>
                        <Grid size={{ xs: 6, md: 3 }}>
                            ...
                            <TextField
                                ...
                                InputProps={{
                                    startAdornment: <IconButton><SearchOutlined /></IconButton>,
                                }}
                            />
                        </Grid>
                        <Grid size={{ xs: 6, md: 2 }}>
            ...
            >
                <Box sx={{ width: 500, p: 3 }}>
                    <Typography variant="h6" sx={{ display: "flex", alignItems: 'center', gap: '10px' }} mb={1}><ProductOutlined /> Add Product</Typography>
                    <Stack spacing={2}>
                        {/* FSP Code */}
                        <TextField
                            label="FSP Code"
